...
oat_volts_button = hw_button_add("ARDUINO_UNO_A_D2", oat_vlts_pressed)
...
select_button = hw_button_add("ARDUINO_UNO_A_D3", select_pressed)
...
control_button = hw_button_add("ARDUINO_UNO_A_D4", control_pressed)
